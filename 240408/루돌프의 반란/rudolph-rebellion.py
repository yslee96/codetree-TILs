...
def rudolph_move(trun, row, col):
    ...
    for santa_num,santa_loc in santa_locs.items():
        ...
        heappush(pq, (dist, (-santa_loc[0][0], -santa_loc[0][1]), santa_num))
    if not pq:
        return row, col
    
    _, n_loc, num = heappop(pq)
    ...
    if row + rudolph_dirs[move_dir][0] == t_row and col + rudolph_dirs[move_dir][1] == t_col:
        ...
        while santa_num > 0:
            ...
            steps = rudolph_power if santa_num == num else 1
